...
var emoticons = (function () {
  ...
  var $_1mc03ya7jcfx5ay1 = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_1mc03ya7jcfx5ay1.getHtml(pluginUrl);
  ...
  var $_qierza6jcfx5ay0 = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_qierza6jcfx5ay0.register(editor, pluginUrl);
  });
  var Plugin = function () {
  };
