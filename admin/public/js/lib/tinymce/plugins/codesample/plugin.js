...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_aua9qg9djcfx5auf.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_3o1r4h99jcfx5at9.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_e1dcdn9bjcfx5atc.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_yfoo19ejcfx5auh = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_8khjyg98jcfx5at5 = {
    open: function (editor) {
      var minWidth = $_3o1r4h99jcfx5at9.getDialogMinWidth(editor);
      var minHeight = $_3o1r4h99jcfx5at9.getDialogMinHeight(editor);
      var currentLanguage = $_yfoo19ejcfx5auh.getCurrentLanguage(editor);
      var currentLanguages = $_yfoo19ejcfx5auh.getLanguages(editor);
      var currentCode = $_e1dcdn9bjcfx5atc.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_e1dcdn9bjcfx5atc.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_aua9qg9djcfx5auf.isCodeSample(node)) {
        $_8khjyg98jcfx5at5.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_87xwh497jcfx5at2 = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_aua9qg9djcfx5auf.trimArg($_aua9qg9djcfx5auf.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_aua9qg9djcfx5auf.trimArg($_aua9qg9djcfx5auf.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_3ce2jd9fjcfx5auo = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_3o1r4h99jcfx5at9.getContentCss(editor);
  ...
  var $_58ud3r9gjcfx5aur = { loadCss: loadCss };
  ...
  var $_82yzo79hjcfx5aut = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_3ce2jd9fjcfx5auo.setup(editor);
    $_82yzo79hjcfx5aut.register(editor);
    $_87xwh497jcfx5at2.register(editor);
    editor.on('init', function () {
      $_58ud3r9gjcfx5aur.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_aua9qg9djcfx5auf.isCodeSample(ev.target)) {
        $_8khjyg98jcfx5at5.open(editor);
      }
    });
  });
