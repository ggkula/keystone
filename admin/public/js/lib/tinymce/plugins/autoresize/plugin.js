...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_afsdp682jcfx5anm.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_afsdp682jcfx5anm.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_afsdp682jcfx5anm.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_afsdp682jcfx5anm.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_afsdp682jcfx5anm.getAutoResizeBottomMargin(editor);
    ...
    if ($_afsdp682jcfx5anm.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_dftz5m7zjcfx5anh.resize(editor, oldSize);
    });
  };
  var $_cti9sh7yjcfx5anf = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_cti9sh7yjcfx5anf.register(editor, oldSize);
      $_dftz5m7zjcfx5anh.setup(editor, oldSize);
    }
  });
  var Plugin = function () {
  };
