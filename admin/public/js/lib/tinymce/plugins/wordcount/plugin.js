...
var wordcount = (function () {
  ...
  var $_cwrpklrqjcfx5fho = {
    each: each,
    map: map
  };

  var SETS$1 = $_vjpl0rojcfx5fhg.SETS;
  var OTHER = $_vjpl0rojcfx5fhg.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_cwrpklrqjcfx5fho.map(string.split(''), memoized);
  };
  var $_acva6grpjcfx5fhk = { classify: classify };

  var ci = $_vjpl0rojcfx5fhg.characterIndices;
  ...
  var $_gfntwirrjcfx5fhs = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING = $_vjpl0rojcfx5fhg.EMPTY_STRING;
  var WHITESPACE = $_vjpl0rojcfx5fhg.WHITESPACE;
  var PUNCTUATION = $_vjpl0rojcfx5fhg.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_acva6grpjcfx5fhk.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_gfntwirrjcfx5fhs.isWordBoundary(map, i)) {
  ...
  var $_g3smzqrnjcfx5fha = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_g3smzqrnjcfx5fha.getWords(getTextContent(editor)).length;
  };
  var $_bl0smzrmjcfx5fh7 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_bl0smzrmjcfx5fh7.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_gbr5ewrljcfx5fh4 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_bl0smzrmjcfx5fh7.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_1u0pkarsjcfx5fhv = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_1u0pkarsjcfx5fhv.setup(editor);
    return $_gbr5ewrljcfx5fh4.get(editor);
  });
  var Plugin = function () {
  };
