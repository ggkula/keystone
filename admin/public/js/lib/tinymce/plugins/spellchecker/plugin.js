...
var spellchecker = (function () {
  ...
  var $_ajjna5iojcfx5cjy = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_g7u9ksiqjcfx5ck1.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_g7u9ksiqjcfx5ck1.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_g7u9ksiqjcfx5ck1.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_y4hh3ivjcfx5ckb.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_g7u9ksiqjcfx5ck1.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_y4hh3ivjcfx5ckb.fireSpellcheckStart(editor);
  };
  var $_88dr3zirjcfx5ck4 = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_g7u9ksiqjcfx5ck1.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_g7u9ksiqjcfx5ck1.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_88dr3zirjcfx5ck4.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_4obyjjipjcfx5cjz = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_88dr3zirjcfx5ck4.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_abrmt7ixjcfx5ckn = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_g7u9ksiqjcfx5ck1.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_g7u9ksiqjcfx5ck1.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_3cu3c6iyjcfx5ckr = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_88dr3zirjcfx5ck4.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_88dr3zirjcfx5ck4.addToDictionary(editor, pluginUrl, startedState, textMatcherState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_88dr3zirjcfx5ck4.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_88dr3zirjcfx5ck4.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_88dr3zirjcfx5ck4.findSpansByIndex(editor, $_88dr3zirjcfx5ck4.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_8dbhtsizjcfx5ckw = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_ajjna5iojcfx5cjy.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_g7u9ksiqjcfx5ck1.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_3cu3c6iyjcfx5ckr.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_8dbhtsizjcfx5ckw.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState);
      $_abrmt7ixjcfx5ckn.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_4obyjjipjcfx5cjz.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  var Plugin = function () {
  };
