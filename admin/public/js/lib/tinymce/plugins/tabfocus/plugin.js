...
var tabfocus = (function () {
  ...
  var $_szpk6jbjcfx5cn6 = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_szpk6jbjcfx5cn6.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_m7uhbj4jcfx5cmw = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_m7uhbj4jcfx5cmw.setup(editor);
  });
  var Plugin = function () {
  };
