...
var contextmenu = (function () {
  ...
  var $_2cfcjf9sjcfx5awq = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_bxyfb69rjcfx5awp.getContextMenu(editor);
  ...
  var $_721v7n9vjcfx5awv = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_bxyfb69rjcfx5awp.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_721v7n9vjcfx5awv.show(editor, $_2cfcjf9sjcfx5awq.getPos(editor, e), visibleState, menu);
    });
  };
  var $_5v36tb9qjcfx5awo = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_5v36tb9qjcfx5awo.setup(editor, visibleState, menu);
    return $_azrw9z9pjcfx5awm.get(visibleState);
  });
  var Plugin = function () {
  };
