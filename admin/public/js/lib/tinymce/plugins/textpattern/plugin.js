...
var textpattern = (function () {
  ...
  var $_bpi8u5q3jcfx5f5e = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_24defdqbjcfx5f64.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_24defdqbjcfx5f64.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_24defdqbjcfx5f64.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_1yf38iq8jcfx5f5s.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_1yf38iq8jcfx5f5s.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_1yf38iq8jcfx5f5s.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !VK.modifierPressed(e)) {
        $_6jn25oq7jcfx5f5m.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_6jn25oq7jcfx5f5m.checkKeyCode(keyCodes, e)) {
        $_6jn25oq7jcfx5f5m.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_6jn25oq7jcfx5f5m.checkCharCode(charCodes, e)) {
  ...
  var $_9xeepoq4jcfx5f5h = { setup: setup };

  PluginManager.add('textpattern', function (editor) {
    var patternsState = Cell($_bpi8u5q3jcfx5f5e.getPatterns(editor.settings));
    $_9xeepoq4jcfx5f5h.setup(editor, patternsState);
    return $_6bj3soq2jcfx5f5b.get(patternsState);
  });
  var Plugin = function () {
  };
