...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_3ea1njdvjcfx5bvd.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_3ea1njdvjcfx5bvd.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_3ea1njdvjcfx5bvd.getSelectorConverter(editor)) {
      selectorConverter = $_3ea1njdvjcfx5bvd.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_3ea1njdvjcfx5bvd.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_3ea1njdvjcfx5bvd.getCssGroups(editor));
      ...
      if (!$_3ea1njdvjcfx5bvd.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_3ea1njdvjcfx5bvd.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_7o4gpodqjcfx5bv1.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_ak6gn8dpjcfx5bux = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_7o4gpodqjcfx5bv1.setup(editor);
    return $_ak6gn8dpjcfx5bux.get(editor);
  });
  var Plugin = function () {
  };
