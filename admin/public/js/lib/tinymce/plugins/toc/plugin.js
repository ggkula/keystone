...
var toc = (function () {
  ...
  var $_9ig0sbqkjcfx5f9k = { create: create };

  var tocId = $_9ig0sbqkjcfx5f9k.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_fcdtqqqjjcfx5f9i.getTocClass(editor);
    var headerTag = $_fcdtqqqjjcfx5f9i.getTocHeader(editor);
    var selector = generateSelector($_fcdtqqqjjcfx5f9i.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_fcdtqqqjjcfx5f9i.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_fcdtqqqjjcfx5f9i.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_89box2qfjcfx5f8v.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_89box2qfjcfx5f8v.updateToc(editor);
    });
  };
  var $_13tgrzqejcfx5f8q = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_fcdtqqqjjcfx5f9i.getTocClass(editor);
  ...
  var $_f4z8hfqljcfx5f9l = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_89box2qfjcfx5f8v.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_fcdtqqqjjcfx5f9i.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_c1yvsxqmjcfx5f9n = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_13tgrzqejcfx5f8q.register(editor);
    $_c1yvsxqmjcfx5f9n.register(editor);
    $_f4z8hfqljcfx5f9l.setup(editor);
  });
  var Plugin = function () {
  };
