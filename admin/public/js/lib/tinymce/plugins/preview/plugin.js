...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_88q78lhvjcfx5cgn.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_88q78lhvjcfx5cgn.getPreviewDialogWidth(editor);
    var dialogHeight = $_88q78lhvjcfx5cgn.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_8it1v8hwjcfx5cgp.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_75rys0htjcfx5cgl = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_75rys0htjcfx5cgl.open(editor);
    });
  };
  var $_e29fu7hsjcfx5cgk = { register: register };
  ...
  var $_5wx68zhyjcfx5cgs = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_e29fu7hsjcfx5cgk.register(editor);
    $_5wx68zhyjcfx5cgs.register(editor);
  });
  var Plugin = function () {
  };
