...
var inlite = (function () {
  ...
  var $_5xfa0l164jcfx5juc = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_3grbz168jcfx5juj.fromClientRect(clientRect)) : null;
  };
  var $_4q6nxb167jcfx5juh = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_6n3syp166jcfx5juf.result(predicateIds[i].id, $_4q6nxb167jcfx5juh.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_6n3syp166jcfx5juf.result(predicateIds[x].id, $_4q6nxb167jcfx5juh.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_6n3syp166jcfx5juf.result(id, $_4q6nxb167jcfx5juh.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_e73umj16hjcfx5juv.isArray(value)) {
      return value;
    } else if ($_e73umj16hjcfx5juv.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_e73umj16hjcfx5juv.isBoolean(value)) {
  ...
  var $_18f3p716gjcfx5jut = {
    getStringOr: getByTypeOr($_e73umj16hjcfx5juv.isString),
    getBoolOr: getByTypeOr($_e73umj16hjcfx5juv.isBoolean),
    getNumberOr: getByTypeOr($_e73umj16hjcfx5juv.isNumber),
    getHandlerOr: getByTypeOr($_e73umj16hjcfx5juv.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_e73umj16hjcfx5juv.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_3grbz168jcfx5juj.toClientRect(targetRect),
        contentAreaRect: $_3grbz168jcfx5juj.toClientRect(contentAreaRect),
        panelRect: $_3grbz168jcfx5juj.toClientRect(panelRect)
      });
      return $_3grbz168jcfx5juj.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_18f3p716gjcfx5jut.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_18f3p716gjcfx5jut.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_18f3p716gjcfx5jut.getHandlerOr(editor, 'inline_toolbar_position_handler', $_3d84hy16ijcfx5juw.defaultHandler);
  };
  ...
  var fireSkinLoaded = function (editor, callback) {
    var done = function () {
      ...
      $_dwr47i16djcfx5jup.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_emh70i16ejcfx5jur.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded(editor, callback);
    };
    if ($_emh70i16ejcfx5jur.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_9jaai816cjcfx5juo = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_5xfa0l164jcfx5juc.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_9klh3t169jcfx5juk.fromContextToolbars(toolbars);
    result = $_6n3syp166jcfx5juf.match(editor, [
      $_dw8tl0165jcfx5jue.element(elements[0], contextToolbarsPredicateIds),
      $_8czcmi16bjcfx5jum.textSelection('text'),
      $_8czcmi16bjcfx5jum.emptyTextBlock(elements, 'insert'),
      $_dw8tl0165jcfx5jue.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_6n3syp166jcfx5juf.match(editor, [$_8czcmi16bjcfx5jum.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_9jaai816cjcfx5juo.load(editor, function () {
  ...
  var $_6u0j7c160jcfx5ju7 = { renderUI: renderUI };
  ...
  var never = $_ecafvc16njcfx5jvf.never;
  var always = $_ecafvc16njcfx5jvf.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_ecafvc16njcfx5jvf.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var indexOf = function (xs, x) {
    ...
    return r === -1 ? $_4sxvpn16mjcfx5jvc.none() : $_4sxvpn16mjcfx5jvc.some(r);
  };
  ...
  var find = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_4sxvpn16mjcfx5jvc.some(x);
      }
    }
    return $_4sxvpn16mjcfx5jvc.none();
  };
  var findIndex = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_4sxvpn16mjcfx5jvc.some(i);
      }
    }
    return $_4sxvpn16mjcfx5jvc.none();
  };
  ...
  var head = function (xs) {
    return xs.length === 0 ? $_4sxvpn16mjcfx5jvc.none() : $_4sxvpn16mjcfx5jvc.some(xs[0]);
  };
  var last = function (xs) {
    return xs.length === 0 ? $_4sxvpn16mjcfx5jvc.none() : $_4sxvpn16mjcfx5jvc.some(xs[xs.length - 1]);
  };
  var $_1qltk516ljcfx5jv6 = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_a792kj16ujcfx5jwf.parseBox(settings.border);
      self.paddingBox = $_a792kj16ujcfx5jwf.parseBox(settings.padding);
      self.marginBox = $_a792kj16ujcfx5jwf.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_a792kj16ujcfx5jwf.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_a792kj16ujcfx5jwf.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_a792kj16ujcfx5jwf.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_3f9ro7171jcfx5jx1.remove(this);
  ...
  var NotificationManagerImpl = function (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_1qltk516ljcfx5jv6.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_1qltk516ljcfx5jv6.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_a792kj16ujcfx5jwf.parseBox(self.settings.border);
          ...
          self.borderBox = $_a792kj16ujcfx5jwf.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_6u0j7c160jcfx5ju7.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_cyb3po15zjcfx5ju6 = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_5e25ud17ljcfx5jzd.resolve(name, scope);
  };
  ...
  var $_bmpne717kjcfx5jza = { getOrDie: getOrDie };

  var FileReader = function () {
    var f = $_bmpne717kjcfx5jza.getOrDie('FileReader');
    return new f();
  };
  ...
  var $_85f9m717ijcfx5jz5 = { blobToBase64: blobToBase64 };
  ...
  var $_6gsfhq17ojcfx5jzg = { pickFile: pickFile };
  ...
  var $_3sw4mz17qjcfx5jzl = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_cxyo3517sjcfx5jzp.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_cxyo3517sjcfx5jzp.resolve(dom, bookmark));
  };
  ...
  var $_8xzgw317rjcfx5jzm = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_3sw4mz17qjcfx5jzl.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_8xzgw317rjcfx5jzm.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_3t6rcx17pjcfx5jzi.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_6gsfhq17ojcfx5jzg.pickFile().then(function (files) {
          var blob = files[0];
          $_85f9m717ijcfx5jz5.blobToBase64(blob).then(function (base64) {
            $_3t6rcx17pjcfx5jzi.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_3t6rcx17pjcfx5jzi.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_7yixjj17hjcfx5jz3 = { addToEditor: addToEditor };
  ...
  var getUiContainerDelta = function () {
    ...
    if (uiContainer && DOMUtils.DOM.getStyle(uiContainer, 'position', true) !== 'static') {
      ...
      return $_4sxvpn16mjcfx5jvc.some({
        x: dx,
        y: dy
      });
    } else {
  ...
  var $_ef1wgn17wjcfx5jzy = { getUiContainerDelta: getUiContainerDelta };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_bxuz7j17yjcfx5k07.isAbsolute(href) && $_bxuz7j17yjcfx5k07.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_3t6rcx17pjcfx5jzi.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_3t6rcx17pjcfx5jzi.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_93sjya17xjcfx5k02 = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_e73umj16hjcfx5juv.isArray(items)) {
      return items;
    } else if ($_e73umj16hjcfx5juv.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_5fds0b17zjcfx5k0a = { create: create$2 };

  var Panel$1 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_5fds0b17zjcfx5k0a.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_5fds0b17zjcfx5k0a.create(editor, 'text', $_emh70i16ejcfx5jur.getTextSelectionToolbarItems(editor)),
        $_5fds0b17zjcfx5k0a.create(editor, 'insert', $_emh70i16ejcfx5jur.getInsertToolbarItems(editor)),
        $_93sjya17xjcfx5k02.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_emh70i16ejcfx5jur.getPositionHandler(editor);
      contentAreaRect = $_4q6nxb167jcfx5juh.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_3d84hy16ijcfx5juw.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_3d84hy16ijcfx5juw.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_ef1wgn17wjcfx5jzy.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_3d84hy16ijcfx5juw.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_4q6nxb167jcfx5juh.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_3d84hy16ijcfx5juw.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_3d84hy16ijcfx5juw.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_dwr47i16djcfx5jup.fireBeforeRenderUI(editor);
  ...
  var $_g2k4bj18mjcfx5k3b = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_ecafvc16njcfx5jvf.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return $_4sxvpn16mjcfx5jvc.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_593njr18njcfx5k3e = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_80fer918rjcfx5k3t = { cached: cached };

  var $_5dibbo18tjcfx5k3w = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_5dibbo18tjcfx5k3w.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_5dibbo18tjcfx5k3w.ELEMENT);
  var isText = isType$1($_5dibbo18tjcfx5k3w.TEXT);
  var isDocument = isType$1($_5dibbo18tjcfx5k3w.DOCUMENT);
  var $_57z5gn18sjcfx5k3u = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_57z5gn18sjcfx5k3u.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_80fer918rjcfx5k3t.cached(function () {
    return getBody($_593njr18njcfx5k3e.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_593njr18njcfx5k3e.fromDom(body);
  };
  var $_cydxfb18qjcfx5k3q = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  var Immutable = function () {
    ...
    return function () {
      ...
      var struct = {};
      $_1qltk516ljcfx5jv6.each(fields, function (name, i) {
        struct[name] = $_ecafvc16njcfx5jvf.constant(values[i]);
      });
      return struct;
    };
  };
  ...
  var validateStrArr = function (label, array) {
    if (!$_68whgp18vjcfx5k49.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_1qltk516ljcfx5jv6.each(array, function (a) {
      if (!$_68whgp18vjcfx5k49.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_1qltk516ljcfx5jv6.find(sorted, function (s, i) {
  ...
  var MixedBag = function (required, optional) {
    ...
    $_enrvj2190jcfx5k4k.validateStrArr('required', required);
    $_enrvj2190jcfx5k4k.validateStrArr('optional', optional);
    $_enrvj2190jcfx5k4k.checkDupes(everything);
    return function (obj) {
      var keys = $_4xb8v918zjcfx5k4h.keys(obj);
      var allReqd = $_1qltk516ljcfx5jv6.forall(required, function (req) {
        return $_1qltk516ljcfx5jv6.contains(keys, req);
      });
      if (!allReqd)
        $_enrvj2190jcfx5k4k.reqMessage(required, keys);
      var unsupported = $_1qltk516ljcfx5jv6.filter(keys, function (key) {
        return !$_1qltk516ljcfx5jv6.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_enrvj2190jcfx5k4k.unsuppMessage(unsupported);
      var r = {};
      $_1qltk516ljcfx5jv6.each(required, function (req) {
        r[req] = $_ecafvc16njcfx5jvf.constant(obj[req]);
      });
      $_1qltk516ljcfx5jv6.each(optional, function (opt) {
        r[opt] = $_ecafvc16njcfx5jvf.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? $_4sxvpn16mjcfx5jvc.some(obj[opt]) : $_4sxvpn16mjcfx5jvc.none());
      });
      return r;
    };
  };

  var $_3j2h4t18wjcfx5k4b = {
    immutable: Immutable,
  ...
  var $_4zqsrv191jcfx5k4m = { toArray: toArray };

  var node = function () {
    var f = $_bmpne717kjcfx5jza.getOrDie('Node');
    return f;
  };
  ...
  var unknown = function () {
    return nu({
      current: undefined,
      version: $_cahcic197jcfx5k56.unknown()
    });
  };
  ...
  var $_5z7757196jcfx5k52 = {
    unknown: unknown,
    nu: nu,
    edge: $_ecafvc16njcfx5jvf.constant(edge),
    chrome: $_ecafvc16njcfx5jvf.constant(chrome),
    ie: $_ecafvc16njcfx5jvf.constant(ie),
    opera: $_ecafvc16njcfx5jvf.constant(opera),
    firefox: $_ecafvc16njcfx5jvf.constant(firefox),
    safari: $_ecafvc16njcfx5jvf.constant(safari)
  };
  ...
  var $_5tmc1g198jcfx5k58 = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_ecafvc16njcfx5jvf.constant(windows$1),
    ios: $_ecafvc16njcfx5jvf.constant(ios),
    android: $_ecafvc16njcfx5jvf.constant(android),
    linux: $_ecafvc16njcfx5jvf.constant(linux),
    osx: $_ecafvc16njcfx5jvf.constant(osx),
    solaris: $_ecafvc16njcfx5jvf.constant(solaris),
    freebsd: $_ecafvc16njcfx5jvf.constant(freebsd)
  };
  ...
  var DeviceType = function (os, browser, userAgent) {
    ...
    return {
      isiPad: $_ecafvc16njcfx5jvf.constant(isiPad),
      isiPhone: $_ecafvc16njcfx5jvf.constant(isiPhone),
      isTablet: $_ecafvc16njcfx5jvf.constant(isTablet),
      isPhone: $_ecafvc16njcfx5jvf.constant(isPhone),
      isTouch: $_ecafvc16njcfx5jvf.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_ecafvc16njcfx5jvf.constant(iOSwebview)
    };
  };

  var detect$3 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_1qltk516ljcfx5jv6.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$3(browsers, userAgent).map(function (browser) {
      var version = $_cahcic197jcfx5k56.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$3(oses, userAgent).map(function (os) {
      var version = $_cahcic197jcfx5k56.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var head$1 = function (str) {
    return str === '' ? $_4sxvpn16mjcfx5jvc.none() : $_4sxvpn16mjcfx5jvc.some(str.substr(0, 1));
  };
  var tail = function (str) {
    return str === '' ? $_4sxvpn16mjcfx5jvc.none() : $_4sxvpn16mjcfx5jvc.some(str.substring(1));
  };
  var $_6v3vb19ejcfx5k60 = {
    first: first,
    last: last$1,
    head: head$1,
    tail: tail
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_f33msx19djcfx5k5y.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_f33msx19djcfx5k5y.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_f33msx19djcfx5k5y.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_f33msx19djcfx5k5y.addToEnd(str, prefix);
  };
  var contains$2 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_6v3vb19ejcfx5k60.head(str).bind(function (head) {
      return $_6v3vb19ejcfx5k60.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_7eaaz119cjcfx5k5w.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_7eaaz119cjcfx5k5w.contains(uastring, 'edge/') && $_7eaaz119cjcfx5k5w.contains(uastring, 'chrome') && $_7eaaz119cjcfx5k5w.contains(uastring, 'safari') && $_7eaaz119cjcfx5k5w.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_7eaaz119cjcfx5k5w.contains(uastring, 'chrome') && !$_7eaaz119cjcfx5k5w.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_7eaaz119cjcfx5k5w.contains(uastring, 'msie') || $_7eaaz119cjcfx5k5w.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_7eaaz119cjcfx5k5w.contains(uastring, 'safari') || $_7eaaz119cjcfx5k5w.contains(uastring, 'mobile/')) && $_7eaaz119cjcfx5k5w.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_7eaaz119cjcfx5k5w.contains(uastring, 'iphone') || $_7eaaz119cjcfx5k5w.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_fzspdw19bjcfx5k5q = {
    browsers: $_ecafvc16njcfx5jvf.constant(browsers),
    oses: $_ecafvc16njcfx5jvf.constant(oses)
  };

  var detect$1 = function (userAgent) {
    var browsers = $_fzspdw19bjcfx5k5q.browsers();
    var oses = $_fzspdw19bjcfx5k5q.oses();
    var browser = $_2v9fza19ajcfx5k5m.detectBrowser(browsers, userAgent).fold($_5z7757196jcfx5k52.unknown, $_5z7757196jcfx5k52.nu);
    var os = $_2v9fza19ajcfx5k5m.detectOs(oses, userAgent).fold($_5tmc1g198jcfx5k58.unknown, $_5tmc1g198jcfx5k58.nu);
  ...
  var $_2njgm195jcfx5k50 = { detect: detect$1 };

  var detect = $_80fer918rjcfx5k3t.cached(function () {
    var userAgent = navigator.userAgent;
    return $_2njgm195jcfx5k50.detect(userAgent);
  });
  var $_b6ufgq194jcfx5k4y = { detect: detect };

  var ELEMENT = $_5dibbo18tjcfx5k3w.ELEMENT;
  var DOCUMENT = $_5dibbo18tjcfx5k3w.DOCUMENT;
  ...
  var all$2 = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_1qltk516ljcfx5jv6.map(base.querySelectorAll(selector), $_593njr18njcfx5k3e.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? $_4sxvpn16mjcfx5jvc.none() : $_4sxvpn16mjcfx5jvc.from(base.querySelector(selector)).map($_593njr18njcfx5k3e.fromDom);
  };
  var $_4b82t719fjcfx5k61 = {
    all: all$2,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_1qltk516ljcfx5jv6.exists(elements, $_ecafvc16njcfx5jvf.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_4d6bb4193jcfx5k4w.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_b6ufgq194jcfx5k4y.detect().browser;
  var contains$1 = browser.isIE() ? ieContains : regularContains;
  var $_3mmrum192jcfx5k4n = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$1,
    is: $_4b82t719fjcfx5k61.is
  };

  var owner = function (element) {
    return $_593njr18njcfx5k3e.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_593njr18njcfx5k3e.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_593njr18njcfx5k3e.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return $_4sxvpn16mjcfx5jvc.from(dom.parentNode).map($_593njr18njcfx5k3e.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children$2(p);
      return $_1qltk516ljcfx5jv6.findIndex(kin, function (elem) {
        return $_3mmrum192jcfx5k4n.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_68whgp18vjcfx5k49.isFunction(isRoot) ? isRoot : $_ecafvc16njcfx5jvf.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_593njr18njcfx5k3e.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings$2 = function (element) {
    var filterSelf = function (elements) {
      return $_1qltk516ljcfx5jv6.filter(elements, function (x) {
        return !$_3mmrum192jcfx5k4n.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return $_4sxvpn16mjcfx5jvc.from(dom.offsetParent).map($_593njr18njcfx5k3e.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return $_4sxvpn16mjcfx5jvc.from(dom.previousSibling).map($_593njr18njcfx5k3e.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return $_4sxvpn16mjcfx5jvc.from(dom.nextSibling).map($_593njr18njcfx5k3e.fromDom);
  };
  var prevSiblings = function (element) {
    return $_1qltk516ljcfx5jv6.reverse($_4zqsrv191jcfx5k4m.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_4zqsrv191jcfx5k4m.toArray(element, nextSibling);
  };
  var children$2 = function (element) {
    var dom = element.dom();
    return $_1qltk516ljcfx5jv6.map(dom.childNodes, $_593njr18njcfx5k3e.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return $_4sxvpn16mjcfx5jvc.from(children[index]).map($_593njr18njcfx5k3e.fromDom);
  };
  ...
  var spot = $_3j2h4t18wjcfx5k4b.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children$2(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_5htuqt18ujcfx5k3x = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants$1($_cydxfb18qjcfx5k3q.body(), predicate);
  };
  var ancestors$1 = function (scope, predicate, isRoot) {
    return $_1qltk516ljcfx5jv6.filter($_5htuqt18ujcfx5k3x.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_1qltk516ljcfx5jv6.filter($_5htuqt18ujcfx5k3x.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_1qltk516ljcfx5jv6.filter($_5htuqt18ujcfx5k3x.children(scope), predicate);
  };
  var descendants$1 = function (scope, predicate) {
    var result = [];
    $_1qltk516ljcfx5jv6.each($_5htuqt18ujcfx5k3x.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all = function (selector) {
    return $_4b82t719fjcfx5k61.all(selector);
  };
  var ancestors = function (scope, selector, isRoot) {
    return $_cy8jv318pjcfx5k3n.ancestors(scope, function (e) {
      return $_4b82t719fjcfx5k61.is(e, selector);
    }, isRoot);
  };
  var siblings = function (scope, selector) {
    return $_cy8jv318pjcfx5k3n.siblings(scope, function (e) {
      return $_4b82t719fjcfx5k61.is(e, selector);
    });
  };
  var children = function (scope, selector) {
    return $_cy8jv318pjcfx5k3n.children(scope, function (e) {
      return $_4b82t719fjcfx5k61.is(e, selector);
    });
  };
  var descendants = function (scope, selector) {
    return $_4b82t719fjcfx5k61.all(selector, scope);
  };
  var $_6fzew318ojcfx5k3l = {
    all: all,
    ancestors: ancestors,
    siblings: siblings,
    children: children,
  ...
  var select = function (selector, root) {
    return $_1qltk516ljcfx5jv6.map($_6fzew318ojcfx5k3l.descendants($_593njr18njcfx5k3e.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_g2k4bj18mjcfx5k3b.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_ecafvc16njcfx5jvf.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_1qltk516ljcfx5jv6.map($_1qltk516ljcfx5jv6.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_1qltk516ljcfx5jv6.map($_1qltk516ljcfx5jv6.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$1 = function (elm) {
    ...
    return $_1qltk516ljcfx5jv6.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_84gmq218ljcfx5k2o = { find: find$1 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_ecafvc16njcfx5jvf.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_1qltk516ljcfx5jv6.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_1qltk516ljcfx5jv6.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_1qltk516ljcfx5jv6.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_1qltk516ljcfx5jv6.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_1qltk516ljcfx5jv6.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_84gmq218ljcfx5k2o.find(bodyElm);
  ...
  var ClosestOrAncestor = function (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? $_4sxvpn16mjcfx5jvc.some(scope) : $_68whgp18vjcfx5k49.isFunction(isRoot) && isRoot(scope) ? $_4sxvpn16mjcfx5jvc.none() : ancestor(scope, a, isRoot);
  };

  var first$2 = function (predicate) {
    return descendant$1($_cydxfb18qjcfx5k3q.body(), predicate);
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_593njr18njcfx5k3e.fromDom(element);
      if (predicate(el))
        return $_4sxvpn16mjcfx5jvc.some(el);
      else if (stop(el))
        break;
    }
    return $_4sxvpn16mjcfx5jvc.none();
  ...
  var sibling$1 = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return $_4sxvpn16mjcfx5jvc.none();
    return child$2($_593njr18njcfx5k3e.fromDom(element.parentNode), function (x) {
      return !$_3mmrum192jcfx5k4n.eq(scope, x) && predicate(x);
    });
  };
  var child$2 = function (scope, predicate) {
    var result = $_1qltk516ljcfx5jv6.find(scope.dom().childNodes, $_ecafvc16njcfx5jvf.compose(predicate, $_593njr18njcfx5k3e.fromDom));
    return result.map($_593njr18njcfx5k3e.fromDom);
  };
  var descendant$1 = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_593njr18njcfx5k3e.fromDom(element.childNodes[i])))
          return $_4sxvpn16mjcfx5jvc.some($_593njr18njcfx5k3e.fromDom(element.childNodes[i]));
  ...
  var first$1 = function (selector) {
    return $_4b82t719fjcfx5k61.one(selector);
  };
  var ancestor = function (scope, selector, isRoot) {
    return $_fp0chb19ljcfx5k6m.ancestor(scope, function (e) {
      return $_4b82t719fjcfx5k61.is(e, selector);
    }, isRoot);
  };
  var sibling = function (scope, selector) {
    return $_fp0chb19ljcfx5k6m.sibling(scope, function (e) {
      return $_4b82t719fjcfx5k61.is(e, selector);
    });
  };
  var child$1 = function (scope, selector) {
    return $_fp0chb19ljcfx5k6m.child(scope, function (e) {
      return $_4b82t719fjcfx5k61.is(e, selector);
    });
  };
  var descendant = function (scope, selector) {
    return $_4b82t719fjcfx5k61.one(selector, scope);
  };
  var closest = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_4b82t719fjcfx5k61.is, ancestor, scope, selector, isRoot);
  };
  var $_8ohigc19kjcfx5k6k = {
    first: first$1,
    ancestor: ancestor,
    sibling: sibling,
    child: child$1,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_b5igi19ojcfx5k73.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_b5igi19ojcfx5k73.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_b5igi19ojcfx5k73.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_b5igi19ojcfx5k73.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_b5igi19ojcfx5k73.postRenderFormat(editor, name)
      });
    });
  };
  var $_ewuumz19njcfx5k71 = { register: register };

  var getSpecifiedFontProp = function (propName, rootElm, elm) {
    while (elm !== rootElm) {
      if (elm.style[propName]) {
        var foundStyle = elm.style[propName];
        return foundStyle !== '' ? $_4sxvpn16mjcfx5jvc.some(foundStyle) : $_4sxvpn16mjcfx5jvc.none();
      }
      elm = elm.parentNode;
    }
    return $_4sxvpn16mjcfx5jvc.none();
  ...
  var getComputedFontProp = function (propName, elm) {
    return $_4sxvpn16mjcfx5jvc.from(DOMUtils.DOM.getStyle(elm, propName, true));
  };
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return $_4sxvpn16mjcfx5jvc.from(elm).map($_593njr18njcfx5k3e.fromDom).filter($_57z5gn18sjcfx5k3u.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_9rievp19qjcfx5k79 = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_ecafvc16njcfx5jvf.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_9rievp19qjcfx5k79.getFontFamily(editor.getBody(), e.element);
  ...
  var $_czyn4n19pjcfx5k76 = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_9rievp19qjcfx5k79.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_9rievp19qjcfx5k79.toPt(px, precision);
  ...
  var $_a1lwjs19rjcfx5k7f = { register: register$2 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_b5igi19ojcfx5k73.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_b5igi19ojcfx5k73.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_3j07wi19sjcfx5k7i = { register: register$3 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_b5igi19ojcfx5k73.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_c3fi1o19tjcfx5k7p = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_1qltk516ljcfx5jv6.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_1qltk516ljcfx5jv6.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_1qltk516ljcfx5jv6.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_6ptbhe19ujcfx5k83 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_b5igi19ojcfx5k73.postRenderFormat(editor, name),
        onclick: $_b5igi19ojcfx5k73.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_b5igi19ojcfx5k73.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_ezwlhd19vjcfx5k86 = { register: register$6 };
  ...
  var $_9inumu19wjcfx5k88 = { register: register$7 };
  ...
  var $_9j3pyg19xjcfx5k8a = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_8ohigc19kjcfx5k6k.descendant($_593njr18njcfx5k3e.fromDom(document.body), editor.settings.ui_container).fold($_ecafvc16njcfx5jvf.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_3j07wi19sjcfx5k7i.register(editor);
    $_ewuumz19njcfx5k71.register(editor);
    $_ezwlhd19vjcfx5k86.register(editor);
    $_9inumu19wjcfx5k88.register(editor);
    $_a1lwjs19rjcfx5k7f.register(editor);
    $_czyn4n19pjcfx5k76.register(editor);
    $_c3fi1o19tjcfx5k7p.register(editor);
    $_9j3pyg19xjcfx5k8a.register(editor);
    $_6ptbhe19ujcfx5k83.register(editor);
  };
  var $_g3ydjc19jjcfx5k6f = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_3f9ro7171jcfx5jx1,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_2dv21x17ejcfx5jyu,
      Panel: Panel,
      Movable: $_9ybfdp172jcfx5jxb,
      Resizable: $_3z8fe817fjcfx5jyx,
      ...
      FormatControls: $_g3ydjc19jjcfx5k6f,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = Panel$1();
    $_g3ydjc19jjcfx5k6f.setup(editor);
    $_7yixjj17hjcfx5jz3.addToEditor(editor, panel);
    return $_cyb3po15zjcfx5ju6.get(editor, panel);
  });
  var Theme = function () {
  };
